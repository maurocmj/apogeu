...
const Exams = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // --- INÍCIO DO PROCESSAMENTO FRONTEND (Bypass Edge Function) ---
      ...
      await supabase.from('medical_exams').update({ ai_insights: insights }).eq('id', newExam.id);
